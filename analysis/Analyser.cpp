...
//    setFrameLength(std::chrono::milliseconds(settings.value("frameLength", 35).value<int>()));
    ...
    setFormantMethod((FormantMethod) settings.value("formantMethod", static_cast<int>(LP)).value<int>());
